...
#             workflow = global_state.workflows[workflow_id]["workflow"]
#             thread_id = global_state.workflows[workflow_id]["thread_id"]

#             stream = workflow.stream(
#                 Command(resume={"user_feedback": last_user_message}),
