...
Bob uses the same Claude CLI as Ada. The Ollama env var injection
...
Fully standalone -- all spawn/kill logic is inlined (no shared imports
between minds).
"""
...
async def spawn(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        model: Model name to use (e.g. 'gpt-oss:20b-32k').
