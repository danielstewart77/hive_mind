...
If URL is `http://192.168.4.64:3000` (LAN IP instead of internal Docker hostname), fix it:
...
| Ada label | Label | `1720207192893686912` |
| Daniel label | Label | `1720605269303493825` |
